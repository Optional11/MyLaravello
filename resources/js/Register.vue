            ...
            <div class="w-full sm:shadow-xl sm:bg-white sm:py-8 sm:px-12">
                ...
                <form @submit.prevent="register">
                    <div class="w-full mb-4">
                        <input
                            type="text"
                            class="rounded-sm px-4 pt-2 outline-none focus:outline-none border-gray-400 bg bg-gray-100 border-solid border-2 w-full text-sm"
                    ...
                    <div class="w-full mb-6">
                        <button
                            type="submit"
                            class="rounded-sm px-4 py-2 text-sm bg-green-500 font-bold outline-none hover:outline-none hover:bg-opacity-75 w-full text-white disabled:opacity-25"
                        >
                            Signup
                        </button>
                    </div>
                ...
                <!-- horizontal line -->
                <div class="bg-gray-400 h-px mb-6 w-full"></div>
